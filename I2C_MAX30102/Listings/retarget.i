...
IP_T ip_tbl[] = {
{"SYS",((0x40000000UL) + 0x00000UL),0},
{"CLK",((0x40000000UL) + 0x00200UL),0},
{"INT",((0x40000000UL) + 0x00300UL),0},
{"GPIOA",((0x40000000UL) + 0x04000UL),224+0},
{"GPIOB",((0x40000000UL) + 0x04040UL),224+1},
{"GPIOC",((0x40000000UL) + 0x04080UL),224+2},
{"GPIOD",((0x40000000UL) + 0x040C0UL),224+3},
{"GPIOE",((0x40000000UL) + 0x04100UL),224+4},
{"GPIOF",((0x40000000UL) + 0x04140UL),224+5},
{"GPIOG",((0x40000000UL) + 0x04180UL),224+6},
{"GPIOH",((0x40000000UL) + 0x041C0UL),224+7},
{"GPIO_DBCTL",((0x40000000UL) + 0x04440UL),0},
{"PA",((0x40000000UL) + 0x04800UL) ,224+0},
{"PB",((0x40000000UL) + 0x04800UL)+16*4 ,224+0},
{"PC",((0x40000000UL) + 0x04800UL)+2*16*4,224+0},
{"PD",((0x40000000UL) + 0x04800UL)+3*16*4,224+0},
{"PE",((0x40000000UL) + 0x04800UL)+4*16*4,224+0},
{"PF",((0x40000000UL) + 0x04800UL)+5*16*4,224+0},
{"PG",((0x40000000UL) + 0x04800UL)+6*16*4,224+0},
{"PH",((0x40000000UL) + 0x04800UL)+7*16*4,224+0},
{"PDMA0",((0x40000000UL) + 0x08000UL),0},
{"PDMA1",((0x40000000UL) + 0x18000UL),PDMA1_Attr},
{"USBH",((0x40000000UL) + 0x09000UL),USBH_Attr},
{"FMC",((0x40000000UL) + 0x0C000UL),0},
{"SDH0",((0x40000000UL) + 0x0D000UL),SDH0_Attr},
{"EBI",((0x40000000UL) + 0x10000UL),EBI_Attr},
{"SCU",((0x40000000UL) + 0x2F000UL),0},
{"CRC",((0x40000000UL) + 0x31000UL),CRC_Attr},
{"CRPT",((0x40000000UL) + 0x32000UL),CRPT_Attr},
{"WDT",(((0x40000000UL) + 0x00040000UL) + 0x00000UL),0},
{"WWDT",(((0x40000000UL) + 0x00040000UL) + 0x00100UL),0},
{"RTC",(((0x40000000UL) + 0x00040000UL) + 0x01000UL),RTC_Attr},
{"EADC",(((0x40000000UL) + 0x00040000UL) + 0x03000UL),EADC_Attr},
{"ACMP01",(((0x40000000UL) + 0x00040000UL) + 0x05000UL),ACMP01_Attr},
{"DAC0",(((0x40000000UL) + 0x00040000UL) + 0x07000UL),DAC_Attr},
{"DAC1",(((0x40000000UL) + 0x00040000UL) + 0x07040UL),DAC_Attr},
{"I2S0",(((0x40000000UL) + 0x00040000UL) + 0x08000UL),I2S0_Attr},
{"OTG",(((0x40000000UL) + 0x00040000UL) + 0x0D000UL),OTG_Attr},
{"TMR01",(((0x40000000UL) + 0x00040000UL) + 0x10000UL),0},
{"TMR23",(((0x40000000UL) + 0x00040000UL) + 0x11000UL),TMR23_Attr},
{"EPWM0",(((0x40000000UL) + 0x00040000UL) + 0x18000UL),EPWM0_Attr},
{"EPWM1",(((0x40000000UL) + 0x00040000UL) + 0x19000UL),EPWM1_Attr},
{"BPWM0",(((0x40000000UL) + 0x00040000UL) + 0x1A000UL),BPWM0_Attr},
{"BPWM1",(((0x40000000UL) + 0x00040000UL) + 0x1B000UL),BPWM1_Attr},
{"QSPI0",(((0x40000000UL) + 0x00040000UL) + 0x20000UL),QSPI0_Attr},
{"SPI0",(((0x40000000UL) + 0x00040000UL) + 0x21000UL),SPI0_Attr},
{"SPI1",(((0x40000000UL) + 0x00040000UL) + 0x22000UL),SPI1_Attr},
{"SPI2",(((0x40000000UL) + 0x00040000UL) + 0x23000UL),SPI2_Attr},
{"SPI3",(((0x40000000UL) + 0x00040000UL) + 0x24000UL),SPI3_Attr},
{"UART0",(((0x40000000UL) + 0x00040000UL) + 0x30000UL),UART0_Attr},
{"UART1",(((0x40000000UL) + 0x00040000UL) + 0x31000UL),UART1_Attr},
{"UART2",(((0x40000000UL) + 0x00040000UL) + 0x32000UL),UART2_Attr},
{"UART3",(((0x40000000UL) + 0x00040000UL) + 0x33000UL),UART3_Attr},
{"UART4",(((0x40000000UL) + 0x00040000UL) + 0x34000UL),UART4_Attr},
{"UART5",(((0x40000000UL) + 0x00040000UL) + 0x35000UL),UART5_Attr},
{"I2C0",(((0x40000000UL) + 0x00040000UL) + 0x40000UL),I2C0_Attr},
{"I2C1",(((0x40000000UL) + 0x00040000UL) + 0x41000UL),I2C1_Attr},
{"I2C2",(((0x40000000UL) + 0x00040000UL) + 0x42000UL),I2C2_Attr},
{"SC0",(((0x40000000UL) + 0x00040000UL) + 0x50000UL),SC0_Attr},
{"SC1",(((0x40000000UL) + 0x00040000UL) + 0x51000UL),SC1_Attr},
{"SC2",(((0x40000000UL) + 0x00040000UL) + 0x52000UL),SC2_Attr},
{"CAN0",(((0x40000000UL) + 0x00040000UL) + 0x60000UL),CAN0_Attr},
{"QEI0",(((0x40000000UL) + 0x00040000UL) + 0x70000UL),QEI0_Attr},
{"QEI1",(((0x40000000UL) + 0x00040000UL) + 0x71000UL),QEI1_Attr},
{"ECAP0",(((0x40000000UL) + 0x00040000UL) + 0x74000UL),ECAP0_Attr},
{"ECAP1",(((0x40000000UL) + 0x00040000UL) + 0x75000UL),ECAP1_Attr},
{"TRNG",(((0x40000000UL) + 0x00040000UL) + 0x79000UL),TRNG_Attr},
{"USBD",(((0x40000000UL) + 0x00040000UL) + 0x80000UL),USBD_Attr},
{"USCI0",(((0x40000000UL) + 0x00040000UL) + 0x90000UL), USCI0_Attr},
{"USCI1",(((0x40000000UL) + 0x00040000UL) + 0x91000UL), USCI1_Attr},
{0,(((0x40000000UL) + 0x00040000UL) + 0x91000UL)+4096, 0},
};
...
# 317 "../../Library/StdDriver/src/retarget.c"
    printf("!!---------------------------------------------------------------!!\n");
    printf("                       <<< HardFault >>>\n");
    ...
    else if((inst >> 12) == 5)
    {
        ...
        if(rn == rt)
        {
            ...
            (inst&0x00000800UL)?"LDR":"STR",rt, taddr);
        }
        else
        {
        ...
        if(!secure)
        {
            ...
            for(i=0;i< sizeof(ip_tbl)/sizeof(IP_T)-1;i++)
            {
                ...
                if((taddr >= ip_tbl[i].u32Addr) && (taddr < (ip_tbl[i+1].u32Addr)))
                {
                    ...
                    bit = idx & 0x1f;
                    idx = idx >> 5;
                    s = (((SCU_T *) ((0x40000000UL) + 0x2F000UL))->PNSSET[idx] >> bit) & 1ul;
                    printf("  Illegal access to %s %s in Nonsecure code.\n",(s)?"Nonsecure":"Secure", ip_tbl[i].name);
                    break;
                }


                if((taddr >= (ip_tbl[i].u32Addr+(0x10000000UL))) && (taddr < (ip_tbl[i+1].u32Addr+(0x10000000UL))))
                {
                    idx = ip_tbl[i].u8NSIdx;
                    bit = idx & 0x1f;
                    idx = idx >> 5;
...
void SendChar_ToUART(int ch)
{
    ...
    while(((UART_T *) ((((0x40000000UL) + 0x00040000UL) + 0x30000UL)+(0x10000000UL)))->FIFOSTS & (0x1ul << (23))){}
    ((UART_T *) ((((0x40000000UL) + 0x00040000UL) + 0x30000UL)+(0x10000000UL)))->DAT = (uint32_t)ch;
    if((char)ch == '\n')
    {
        while(((UART_T *) ((((0x40000000UL) + 0x00040000UL) + 0x30000UL)+(0x10000000UL)))->FIFOSTS & (0x1ul << (23))){}
        ((UART_T *) ((((0x40000000UL) + 0x00040000UL) + 0x30000UL)+(0x10000000UL)))->DAT = '\r';
    }
}
# 581 "../../Library/StdDriver/src/retarget.c"
void SendChar(int ch)
{
# 612 "../../Library/StdDriver/src/retarget.c"
    SendChar_ToUART(ch);
...
char GetChar(void)
{
# 663 "../../Library/StdDriver/src/retarget.c"
    while(1)
    {
        if((((UART_T *) ((((0x40000000UL) + 0x00040000UL) + 0x30000UL)+(0x10000000UL)))->FIFOSTS & (0x1ul << (14))) == 0U)
        {
            return ((char)((UART_T *) ((((0x40000000UL) + 0x00040000UL) + 0x30000UL)+(0x10000000UL)))->DAT);
        }
    }


}
# 685 "../../Library/StdDriver/src/retarget.c"
int kbhit(void)
{
    return !((((UART_T *) ((((0x40000000UL) + 0x00040000UL) + 0x30000UL)+(0x10000000UL)))->FIFOSTS & (0x1ul << (14))) == 0U);
}
# 700 "../../Library/StdDriver/src/retarget.c"
int IsDebugFifoEmpty(void)
{
    return ((((UART_T *) ((((0x40000000UL) + 0x00040000UL) + 0x30000UL)+(0x10000000UL)))->FIFOSTS & (0x1ul << (28))) != 0U);
}
# 715 "../../Library/StdDriver/src/retarget.c"
void _ttywrch(int ch)
{
    SendChar(ch);
    return;
}
# 740 "../../Library/StdDriver/src/retarget.c"
int fputc(int ch, FILE *stream)
{
    SendChar(ch);
    return ch;
}
# 790 "../../Library/StdDriver/src/retarget.c"
int fgetc(FILE *stream)
{
    return ((int)GetChar());
}
# 810 "../../Library/StdDriver/src/retarget.c"
int ferror(FILE *stream)
{
    return (-1);
}
