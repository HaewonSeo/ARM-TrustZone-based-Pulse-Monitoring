...
volatile static I2C_FUNC s_I2C1HandlerFn = 0;
...
void Get_Pulse()
{
  ...
  for(i=0; i<1; i++)
   {
   printf("**\n");
   I2C_ReadMultiBytesOneReg(((I2C_T *) (((0x40000000UL) + 0x00040000UL) + 0x40000UL)), 0x57, 0x07, au8RDataBuf, 3);
...
void Config_MAX30102()
{
  ...
  ret = I2C_WriteByteOneReg(((I2C_T *) (((0x40000000UL) + 0x00040000UL) + 0x40000UL)), 0x57, 0x08, 0x10);
  printf("[1]MAX30102_FIFO_CONFIG --- ret %d\n", ret);



  ret = I2C_WriteByteOneReg(((I2C_T *) (((0x40000000UL) + 0x00040000UL) + 0x40000UL)), 0x57, 0x09, 0x02);
  ...
  ret = I2C_WriteByteOneReg(((I2C_T *) (((0x40000000UL) + 0x00040000UL) + 0x40000UL)), 0x57, 0x0A, 0x63);
  printf("[3]MAX30102_SPO2_CONFIG --- ret %d\n", ret);



  ret = I2C_WriteByteOneReg(((I2C_T *) (((0x40000000UL) + 0x00040000UL) + 0x40000UL)), 0x57, 0x0C, 0x3F);
  ...
  ret = I2C_WriteByteOneReg(((I2C_T *) (((0x40000000UL) + 0x00040000UL) + 0x40000UL)), 0x57, 0x11, 0x01);
