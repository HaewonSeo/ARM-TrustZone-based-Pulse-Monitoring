...
void SCU_Setup(void)
{
    ...
    ((SCU_T *) ((0x40000000UL) + 0x2F000UL))->IONSSET = 0xE;
    ...
    if(0xE & 0x00000001UL ) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[0] |= 0x00010000UL;
    if(0xE & 0x00000002UL ) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[0] |= 0x00020000UL;
    if(0xE & 0x00000004UL ) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[0] |= 0x00040000UL;
    if(0xE & 0x00000008UL ) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[0] |= 0x00080000UL;
    if(0xE & 0x00000010UL ) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[0] |= 0x00100000UL;
    if(0xE & 0x00000020UL ) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[0] |= 0x00200000UL;
    if(0xE & 0x00000040UL ) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[2] |= 0x00000100UL ;
    if(0xE & 0x00000080UL ) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[2] |= 0x01000000UL;
