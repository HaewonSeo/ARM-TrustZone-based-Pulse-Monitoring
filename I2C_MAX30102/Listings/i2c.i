...
# 11 "../../Library/StdDriver/src/i2c.c"
...
# 12 "../../Library/StdDriver/src/i2c.c" 2
...
uint32_t I2C_Open(I2C_T *i2c, uint32_t u32BusClock)
{
    ...
    if((i2c == ((I2C_T *) (((0x40000000UL) + 0x00040000UL) + 0x41000UL))) || (i2c == ((I2C_T *) ((((0x40000000UL) + 0x00040000UL) + 0x41000UL)+(0x10000000UL)))))
    {
...
# 73 "../../Library/StdDriver/src/i2c.c"
void I2C_Close(I2C_T *i2c)
{

    if(i2c == ((I2C_T *) (((0x40000000UL) + 0x00040000UL) + 0x40000UL)))
    {
        ((SYS_T *) ((0x40000000UL) + 0x00000UL))->IPRST1 |= (0x1ul << (8));
        ((SYS_T *) ((0x40000000UL) + 0x00000UL))->IPRST1 &= ~(0x1ul << (8));
    }
    else if(i2c == ((I2C_T *) (((0x40000000UL) + 0x00040000UL) + 0x41000UL)))
    {
        ((SYS_T *) ((0x40000000UL) + 0x00000UL))->IPRST1 |= (0x1ul << (9));
        ((SYS_T *) ((0x40000000UL) + 0x00000UL))->IPRST1 &= ~(0x1ul << (9));
    }
    else if(i2c == ((I2C_T *) (((0x40000000UL) + 0x00040000UL) + 0x42000UL)))
    {
        ((SYS_T *) ((0x40000000UL) + 0x00000UL))->IPRST1 |= (0x1ul << (10));
        ((SYS_T *) ((0x40000000UL) + 0x00000UL))->IPRST1 &= ~(0x1ul << (10));
    }
...
# 106 "../../Library/StdDriver/src/i2c.c"
void I2C_ClearTimeoutFlag(I2C_T *i2c)
{
    i2c->TOCTL |= (0x1ul << (0));
}
# 125 "../../Library/StdDriver/src/i2c.c"
void I2C_Trigger(I2C_T *i2c, uint8_t u8Start, uint8_t u8Stop, uint8_t u8Si, uint8_t u8Ack)
{
    uint32_t u32Reg = 0u;
...
# 159 "../../Library/StdDriver/src/i2c.c"
void I2C_DisableInt(I2C_T *i2c)
{
    i2c->CTL0 &= ~(0x1ul << (7));
}
# 174 "../../Library/StdDriver/src/i2c.c"
void I2C_EnableInt(I2C_T *i2c)
{
    i2c->CTL0 |= (0x1ul << (7));
}
# 188 "../../Library/StdDriver/src/i2c.c"
uint32_t I2C_GetBusClockFreq(I2C_T *i2c)
{
...
# 215 "../../Library/StdDriver/src/i2c.c"
uint32_t I2C_SetBusClockFreq(I2C_T *i2c, uint32_t u32BusClock)
{
    uint32_t u32Div;
    uint32_t u32Pclk;
...
# 244 "../../Library/StdDriver/src/i2c.c"
uint32_t I2C_GetIntFlag(I2C_T *i2c)
{
    return ((i2c->CTL0 & (0x1ul << (3))) == (0x1ul << (3)) ? 1ul : 0ul);
}
# 258 "../../Library/StdDriver/src/i2c.c"
uint32_t I2C_GetStatus(I2C_T *i2c)
{
    return (i2c->STATUS0);
}
# 272 "../../Library/StdDriver/src/i2c.c"
uint8_t I2C_GetData(I2C_T *i2c)
{
    return (uint8_t)(i2c->DAT);
}
# 287 "../../Library/StdDriver/src/i2c.c"
void I2C_SetData(I2C_T *i2c, uint8_t u8Data)
{
    i2c->DAT = u8Data;
}
# 306 "../../Library/StdDriver/src/i2c.c"
void I2C_SetSlaveAddr(I2C_T *i2c, uint8_t u8SlaveNo, uint8_t u8SlaveAddr, uint8_t u8GCMode)
{
    switch(u8SlaveNo)
    {
...
# 370 "../../Library/StdDriver/src/i2c.c"
void I2C_EnableTimeout(I2C_T *i2c, uint8_t u8LongTimeout)
{
    if(u8LongTimeout)
    {
...
# 409 "../../Library/StdDriver/src/i2c.c"
void I2C_EnableWakeup(I2C_T *i2c)
{
    i2c->WKCTL |= (0x1ul << (0));
}
# 424 "../../Library/StdDriver/src/i2c.c"
void I2C_DisableWakeup(I2C_T *i2c)
{
    i2c->WKCTL &= ~(0x1ul << (0));
}
# 439 "../../Library/StdDriver/src/i2c.c"
uint32_t I2C_SMBusGetStatus(I2C_T *i2c)
{
    return (i2c->BUSSTS);
}
# 455 "../../Library/StdDriver/src/i2c.c"
void I2C_SMBusClearInterruptFlag(I2C_T *i2c, uint8_t u8SMBusIntFlag)
{
    i2c->BUSSTS = u8SMBusIntFlag;
}
# 471 "../../Library/StdDriver/src/i2c.c"
void I2C_SMBusSetPacketByteCount(I2C_T *i2c, uint32_t u32PktSize)
{
    i2c->PKTSIZE = u32PktSize;
}
# 487 "../../Library/StdDriver/src/i2c.c"
void I2C_SMBusOpen(I2C_T *i2c, uint8_t u8HostDevice)
{
...
# 513 "../../Library/StdDriver/src/i2c.c"
void I2C_SMBusClose(I2C_T *i2c)
{

    i2c->BUSCTL = 0x00U;
}
# 530 "../../Library/StdDriver/src/i2c.c"
void I2C_SMBusPECTxEnable(I2C_T *i2c, uint8_t u8PECTxEn)
{
    i2c->BUSCTL &= ~(0x1ul << (8));
...
# 554 "../../Library/StdDriver/src/i2c.c"
uint8_t I2C_SMBusGetPECValue(I2C_T *i2c)
{
    return (uint8_t)i2c->PKTCRC;
}
# 572 "../../Library/StdDriver/src/i2c.c"
void I2C_SMBusIdleTimeout(I2C_T *i2c, uint32_t u32Us, uint32_t u32Hclk)
{
...
# 604 "../../Library/StdDriver/src/i2c.c"
void I2C_SMBusTimeout(I2C_T *i2c, uint32_t ms, uint32_t u32Pclk)
{
...
# 640 "../../Library/StdDriver/src/i2c.c"
void I2C_SMBusClockLoTimeout(I2C_T *i2c, uint32_t ms, uint32_t u32Pclk)
{
    uint32_t u32Div, u32Pclk_kHz;
...
# 676 "../../Library/StdDriver/src/i2c.c"
uint8_t I2C_WriteByte(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t u8Data)
{
...
# 727 "../../Library/StdDriver/src/i2c.c"
uint32_t I2C_WriteMultiBytes(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t au8Data[], uint32_t u32wLen)
{
    uint8_t u8Xfering = 1u, u8Err = 0u, u8Ctrl = 0u;
...
# 785 "../../Library/StdDriver/src/i2c.c"
uint8_t I2C_WriteByteOneReg(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t u8DataAddr, uint8_t u8Data)
{
    uint8_t u8Xfering = 1u, u8Err = 0u, u8Ctrl = 0u;
    uint32_t u32txLen = 0u;
...
# 847 "../../Library/StdDriver/src/i2c.c"
uint32_t I2C_WriteMultiBytesOneReg(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t u8DataAddr, uint8_t au8Data[], uint32_t u32wLen)
{
    uint8_t u8Xfering = 1u, u8Err = 0u, u8Ctrl = 0u;
    uint32_t u32txLen = 0u;
...
# 908 "../../Library/StdDriver/src/i2c.c"
uint8_t I2C_WriteByteTwoRegs(I2C_T *i2c, uint8_t u8SlaveAddr, uint16_t u16DataAddr, uint8_t u8Data)
{
...
# 975 "../../Library/StdDriver/src/i2c.c"
uint32_t I2C_WriteMultiBytesTwoRegs(I2C_T *i2c, uint8_t u8SlaveAddr, uint16_t u16DataAddr, uint8_t au8Data[], uint32_t u32wLen)
{
    uint8_t u8Xfering = 1u, u8Err = 0u, u8Addr = 1u, u8Ctrl = 0u;
    uint32_t u32txLen = 0u;
...
# 1092 "../../Library/StdDriver/src/i2c.c"
uint32_t I2C_ReadMultiBytes(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t au8Rdata[], uint32_t u32rLen)
{
    uint8_t u8Xfering = 1u, u8Err = 0u, u8Ctrl = 0u;
    ...
    while(u8Xfering && (u8Err == 0u))
    {
        ...
        switch(((i2c)->STATUS0))
        {
            ...
            case 0x48u:
                ...
                break;
            case 0x50u:
                au8Rdata[u32rxLen++] = (unsigned char) ((i2c)->DAT);
...
# 1155 "../../Library/StdDriver/src/i2c.c"
uint8_t I2C_ReadByteOneReg(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t u8DataAddr)
{
...
# 1226 "../../Library/StdDriver/src/i2c.c"
uint32_t I2C_ReadMultiBytesOneReg(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t u8DataAddr, uint8_t au8Rdata[], uint32_t u32rLen)
{
    uint8_t u8Xfering = 1u, u8Err = 0u, u8Ctrl = 0u;
    uint32_t u32rxLen = 0u;
    ...
    while(u8Xfering && (u8Err == 0u))
    {
        ...
        switch(((i2c)->STATUS0))
        {
            ...
            case 0x48u:
                ...
                break;
            case 0x50u:
                au8Rdata[u32rxLen++] = (uint8_t) ((i2c)->DAT);
                if(u32rxLen < (u32rLen - 1u))
                {
                    u8Ctrl = (0x0CU);
                }
...
# 1303 "../../Library/StdDriver/src/i2c.c"
uint8_t I2C_ReadByteTwoRegs(I2C_T *i2c, uint8_t u8SlaveAddr, uint16_t u16DataAddr)
{
...
# 1382 "../../Library/StdDriver/src/i2c.c"
uint32_t I2C_ReadMultiBytesTwoRegs(I2C_T *i2c, uint8_t u8SlaveAddr, uint16_t u16DataAddr, uint8_t au8Rdata[], uint32_t u32rLen)
{
    uint8_t u8Xfering = 1u, u8Err = 0u, u8Addr = 1u, u8Ctrl = 0u;
    uint32_t u32rxLen = 0u;
