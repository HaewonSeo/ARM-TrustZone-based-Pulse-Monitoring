# 1 "../../../ThirdParty/mbedTLS/library/debug.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../ThirdParty/mbedTLS/library/debug.c" 2
# 23 "../../../ThirdParty/mbedTLS/library/debug.c"
...
# 24 "../../../ThirdParty/mbedTLS/library/debug.c" 2
...
# 32 "../../../ThirdParty/mbedTLS/library/debug.c" 2
# 41 "../../../ThirdParty/mbedTLS/library/debug.c"
...
# 42 "../../../ThirdParty/mbedTLS/library/debug.c" 2
...
# 44 "../../../ThirdParty/mbedTLS/library/debug.c" 2
...
# 46 "../../../ThirdParty/mbedTLS/library/debug.c" 2
...
static __inline void debug_send_line( const mbedtls_ssl_context *ssl, int level,
                                    const char *file, int line,
                                    const char *str )
{
# 78 "../../../ThirdParty/mbedTLS/library/debug.c"
                              ...
                              const char *format, ... )
{
    ...
    if( 0 == ssl || 0 == ssl->conf || 0 == ssl->conf->f_dbg || level > debug_threshold )
        return;
                              ...
                              const char *text, int ret )
{
    ...
    if( ssl->conf == 0 || ssl->conf->f_dbg == 0 || level > debug_threshold )
        return;
                              ...
                              const char *text, const mbedtls_mpi *X )
{
    ...
    if( ssl->conf == 0 || ssl->conf->f_dbg == 0 || X == 0 || level > debug_threshold )
        return;
                              ...
                              const char *text, const mbedtls_x509_crt *crt )
{
    ...
    if( ssl->conf == 0 || ssl->conf->f_dbg == 0 || crt == 0 || level > debug_threshold )
        return;
...
# 403 "../../../ThirdParty/mbedTLS/library/debug.c"
}
