# 1 "../../../ThirdParty/mbedTLS/library/x509write_csr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../ThirdParty/mbedTLS/library/x509write_csr.c" 2
# 28 "../../../ThirdParty/mbedTLS/library/x509write_csr.c"
...
# 29 "../../../ThirdParty/mbedTLS/library/x509write_csr.c" 2
...
int mbedtls_x509write_csr_pem( mbedtls_x509write_csr *ctx, unsigned char *buf, size_t size,
                       int (*f_rng)(void *, unsigned char *, size_t),
                       void *p_rng );
# 36 "../../../ThirdParty/mbedTLS/library/x509write_csr.c" 2
...
# 37 "../../../ThirdParty/mbedTLS/library/x509write_csr.c" 2
...
mbedtls_asn1_named_data *mbedtls_asn1_store_named_data( mbedtls_asn1_named_data **list,
                                        ...
                                        size_t val_len );
# 38 "../../../ThirdParty/mbedTLS/library/x509write_csr.c" 2
...
# 46 "../../../ThirdParty/mbedTLS/library/x509write_csr.c" 2
...
# 47 "../../../ThirdParty/mbedTLS/library/x509write_csr.c" 2
...
# 50 "../../../ThirdParty/mbedTLS/library/x509write_csr.c" 2
...
# 154 "../../../ThirdParty/mbedTLS/library/x509write_csr.c"
    ...
    do { if( ( ret = mbedtls_asn1_write_len( &c, tmp_buf, len ) ) < 0 ) return( ret ); else len += ret; } while( 0 );
    do { if( ( ret = mbedtls_asn1_write_tag( &c, tmp_buf, 0x20 | 0x10 ) ) < 0 ) return( ret ); else len += ret; } while( 0 );
# 216 "../../../ThirdParty/mbedTLS/library/x509write_csr.c"
