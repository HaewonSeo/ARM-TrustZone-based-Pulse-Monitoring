# 1 "../../../ThirdParty/mbedTLS/library/pkparse.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../ThirdParty/mbedTLS/library/pkparse.c" 2
# 23 "../../../ThirdParty/mbedTLS/library/pkparse.c"
...
# 24 "../../../ThirdParty/mbedTLS/library/pkparse.c" 2
...
# 31 "../../../ThirdParty/mbedTLS/library/pkparse.c" 2
...
# 32 "../../../ThirdParty/mbedTLS/library/pkparse.c" 2
...
# 33 "../../../ThirdParty/mbedTLS/library/pkparse.c" 2
...
# 36 "../../../ThirdParty/mbedTLS/library/pkparse.c" 2
# 47 "../../../ThirdParty/mbedTLS/library/pkparse.c"
...
# 48 "../../../ThirdParty/mbedTLS/library/pkparse.c" 2
...
# 51 "../../../ThirdParty/mbedTLS/library/pkparse.c" 2
...
# 54 "../../../ThirdParty/mbedTLS/library/pkparse.c" 2
...
# 58 "../../../ThirdParty/mbedTLS/library/pkparse.c" 2
# 188 "../../../ThirdParty/mbedTLS/library/pkparse.c"
...
# 244 "../../../ThirdParty/mbedTLS/library/pkparse.c"
static int pk_group_from_specified( const mbedtls_asn1_buf *params, mbedtls_ecp_group *grp )
{
    ...
    end_field = p + len;
# 280 "../../../ThirdParty/mbedTLS/library/pkparse.c"
    ...
    if( p != end_field )
        return( -0x3D00 +
                -0x0066 );
# 310 "../../../ThirdParty/mbedTLS/library/pkparse.c"
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
                                      0x20 | 0x10 ) ) != 0 )
        return( ret );
...
# 461 "../../../ThirdParty/mbedTLS/library/pkparse.c"
...
# 500 "../../../ThirdParty/mbedTLS/library/pkparse.c"
...
# 527 "../../../ThirdParty/mbedTLS/library/pkparse.c"
                             ...
                             mbedtls_rsa_context *rsa )
{
    ...
    if( ( ret = mbedtls_rsa_import_raw( rsa, *p, len, 0, 0, 0, 0,
                                        0, 0, 0, 0 ) ) != 0 )
        return( -0x3B00 );
    ...
    *p += len;
    ...
    if( ( ret = mbedtls_rsa_import_raw( rsa, 0, 0, 0, 0, 0, 0,
                                        0, 0, *p, len ) ) != 0 )
        return( -0x3B00 );
...
# 582 "../../../ThirdParty/mbedTLS/library/pkparse.c"
                                ...
                                mbedtls_pk_context *pk )
{
    ...
    if( ( pk_info = mbedtls_pk_info_from_type( pk_alg ) ) == 0 )
        return( -0x3C80 );
...
# 713 "../../../ThirdParty/mbedTLS/library/pkparse.c"
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
                                      0x20 | 0x10 ) ) != 0 )
    {
        return( -0x3D00 + ret );
    ...
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
                                      0x02 ) ) != 0 ||
            ( ret = mbedtls_rsa_import_raw( rsa, p, len, 0, 0, 0, 0,
                                            0, 0, 0, 0 ) ) != 0 )
        goto cleanup;
    p += len;
    ...
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
                                      0x02 ) ) != 0 ||
            ( ret = mbedtls_rsa_import_raw( rsa, 0, 0, 0, 0, 0, 0,
                                            0, 0, p, len ) ) != 0 )
        goto cleanup;
    p += len;
    ...
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
                                      0x02 ) ) != 0 ||
            ( ret = mbedtls_rsa_import_raw( rsa, 0, 0, p, len, 0, 0,
                                            0, 0, 0, 0 ) ) != 0 )
        goto cleanup;
    p += len;
    ...
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
                                      0x02 ) ) != 0 ||
            ( ret = mbedtls_rsa_import_raw( rsa, 0, 0, 0, 0, p, len,
                                            0, 0, 0, 0 ) ) != 0 )
        goto cleanup;
    p += len;
                                  ...
                                  size_t keylen )
{
    ...
    unsigned char *end2;
# 832 "../../../ThirdParty/mbedTLS/library/pkparse.c"
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
                                      0x20 | 0x10 ) ) != 0 )
    {
        return( -0x3D00 + ret );
...
# 948 "../../../ThirdParty/mbedTLS/library/pkparse.c"
    ...
    size_t keylen )
{
    ...
    mbedtls_pk_type_t pk_alg = MBEDTLS_PK_NONE;
    const mbedtls_pk_info_t *pk_info;
# 977 "../../../ThirdParty/mbedTLS/library/pkparse.c"
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
                                      0x20 | 0x10 ) ) != 0 )
    {
        return( -0x3D00 + ret );
...
# 1043 "../../../ThirdParty/mbedTLS/library/pkparse.c"
    ...
    const unsigned char *pwd, size_t pwdlen )
{
    ...
    if( pwdlen == 0 )
        return( -0x3C00 );
# 1079 "../../../ThirdParty/mbedTLS/library/pkparse.c"
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
                                      0x20 | 0x10 ) ) != 0 )
    {
        return( -0x3D00 + ret );
                          ...
                          const unsigned char *pwd, size_t pwdlen )
{
    ...
    if( ret == 0 )
    {
        ...
        return( ret );
# 1303 "../../../ThirdParty/mbedTLS/library/pkparse.c"
    {
        unsigned char *key_copy;

        if( ( key_copy = calloc( 1, keylen ) ) == 0 )
            return( -0x3F80 );
    ...
    mbedtls_pk_free( pk );
# 1370 "../../../ThirdParty/mbedTLS/library/pkparse.c"
    return( -0x3D00 );
}
                                 ...
                                 const unsigned char *key, size_t keylen )
{
    ...
    {
        p = pem.buf;
        if( ( pk_info = mbedtls_pk_info_from_type( MBEDTLS_PK_RSA ) ) == 0 )
            return( -0x3C80 );
