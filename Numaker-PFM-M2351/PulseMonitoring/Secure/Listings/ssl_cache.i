# 1 "../../../ThirdParty/mbedTLS/library/ssl_cache.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../ThirdParty/mbedTLS/library/ssl_cache.c" 2
# 27 "../../../ThirdParty/mbedTLS/library/ssl_cache.c"
...
# 28 "../../../ThirdParty/mbedTLS/library/ssl_cache.c" 2
...
# 36 "../../../ThirdParty/mbedTLS/library/ssl_cache.c" 2
...
# 1 "../../../ThirdParty/mbedTLS/include/mbedtls\\ssl_cache.h" 1
# 28 "../../../ThirdParty/mbedTLS/include/mbedtls\\ssl_cache.h"
# 1 "../../../ThirdParty/mbedTLS/include/mbedtls/config.h" 1
# 29 "../../../ThirdParty/mbedTLS/include/mbedtls\\ssl_cache.h" 2
...
# 34 "../../../ThirdParty/mbedTLS/include/mbedtls\\ssl_cache.h" 2
# 61 "../../../ThirdParty/mbedTLS/include/mbedtls\\ssl_cache.h"
...
# 107 "../../../ThirdParty/mbedTLS/include/mbedtls\\ssl_cache.h"
int mbedtls_ssl_cache_get( void *data, mbedtls_ssl_session *session );
# 116 "../../../ThirdParty/mbedTLS/include/mbedtls\\ssl_cache.h"
int mbedtls_ssl_cache_set( void *data, const mbedtls_ssl_session *session );
# 138 "../../../ThirdParty/mbedTLS/include/mbedtls\\ssl_cache.h"
...
# 43 "../../../ThirdParty/mbedTLS/library/ssl_cache.c" 2
...
int mbedtls_ssl_get_key_exchange_md_tls1_2( mbedtls_ssl_context *ssl,
                                            ...
                                            unsigned char *data, size_t data_len,
                                            mbedtls_md_type_t md_alg );
# 44 "../../../ThirdParty/mbedTLS/library/ssl_cache.c" 2
...
# 46 "../../../ThirdParty/mbedTLS/library/ssl_cache.c" 2
...
# 133 "../../../ThirdParty/mbedTLS/library/ssl_cache.c"
        ret = 0;
        goto exit;
    }
...
int mbedtls_ssl_cache_set( void *data, const mbedtls_ssl_session *session )
{
    ...
    {
        count++;
# 178 "../../../ThirdParty/mbedTLS/library/ssl_cache.c"
        if( memcmp( session->id, cur->session.id, cur->session.id_len ) == 0 )
            break;
# 189 "../../../ThirdParty/mbedTLS/library/ssl_cache.c"
        prv = cur;
        cur = cur->next;
    }
    ...
    if( cur == 0 )
    {
# 214 "../../../ThirdParty/mbedTLS/library/ssl_cache.c"
...
# 268 "../../../ThirdParty/mbedTLS/library/ssl_cache.c"
...
# 299 "../../../ThirdParty/mbedTLS/library/ssl_cache.c"
    ret = 0;
...
# 319 "../../../ThirdParty/mbedTLS/library/ssl_cache.c"
void mbedtls_ssl_cache_set_max_entries( mbedtls_ssl_cache_context *cache, int max )
{
    if( max < 0 ) max = 0;
