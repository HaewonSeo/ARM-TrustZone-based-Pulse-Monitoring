# 1 "Crypto/crypto_aes.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Crypto/crypto_aes.c" 2
# 1 "./Crypto/crypto_aes.h" 1
...
void M2351_FMC_Read_Key(uint32_t num, uint32_t len);
void M2351_FMC_Write_Key(void);

void M2351_ECC_GenerateKey(void);
void M2351_ECDSA_GenerateSignature(void);
void M2351_ECDSA_VerificationSignature(void);
# 2 "Crypto/crypto_aes.c" 2
# 1 "../Secure\\nsc.h" 1
...
void M2351_ECDSA_GenerateSignature()
{
  ...
  char gR1[168], gS1[168];
    ...
    if(ECC_GenerateSignature(((CRPT_T *) ((0x40000000UL) + 0x32000UL)), CURVE_P_192, g_SHA_msg, d, gK, gR1, gS1) < 0)
    {
