...
void SCU_Setup(void)
{
    ...
    ((SCU_T *) ((0x40000000UL) + 0x2F000UL))->PNSSET[3] = 0x90004;
    ...
    ((SCU_T *) ((0x40000000UL) + 0x2F000UL))->IONSSET = 0x9E;
    ...
    if(0x90004 & 0x00000001UL ) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[0] |= 0x00400000UL;
    if(0x90004 & 0x00000002UL ) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[0] |= 0x00800000UL;
    if(0x90004 & 0x00000004UL ) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[1] |= 0x00080000UL;
    if(0x90004 & 0x00000008UL ) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[1] |= 0x00100000UL;
    if(0x90004 & 0x00000010UL ) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[1] |= 0x40000000UL;
    if(0x90004 & 0x00010000UL) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[1] |= 0x00000010UL ;
    if(0x90004 & 0x00020000UL) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[1] |= 0x00000020UL ;
    if(0x90004 & 0x00040000UL) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[1] |= 0x00010000UL;
    if(0x90004 & 0x00080000UL) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[1] |= 0x00020000UL;
    if(0x90004 & 0x00100000UL) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[2] |= 0x00000400UL;
    if(0x90004 & 0x00200000UL) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[2] |= 0x00000800UL;
    ...
    if(0x9E & 0x00000001UL ) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[0] |= 0x00010000UL;
    if(0x9E & 0x00000002UL ) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[0] |= 0x00020000UL;
    if(0x9E & 0x00000004UL ) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[0] |= 0x00040000UL;
    if(0x9E & 0x00000008UL ) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[0] |= 0x00080000UL;
    if(0x9E & 0x00000010UL ) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[0] |= 0x00100000UL;
    if(0x9E & 0x00000020UL ) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[0] |= 0x00200000UL;
    if(0x9E & 0x00000040UL ) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[2] |= 0x00000100UL ;
    if(0x9E & 0x00000080UL ) ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ITNS[2] |= 0x01000000UL;
