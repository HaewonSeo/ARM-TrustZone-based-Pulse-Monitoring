# 1 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../ThirdParty/mbedTLS/library/ssl_cli.c" 2
# 23 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
...
# 24 "../../../ThirdParty/mbedTLS/library/ssl_cli.c" 2
...
# 32 "../../../ThirdParty/mbedTLS/library/ssl_cli.c" 2
...
# 39 "../../../ThirdParty/mbedTLS/library/ssl_cli.c" 2
...
int mbedtls_ssl_get_key_exchange_md_tls1_2( mbedtls_ssl_context *ssl,
                                            ...
                                            unsigned char *data, size_t data_len,
                                            mbedtls_md_type_t md_alg );
# 41 "../../../ThirdParty/mbedTLS/library/ssl_cli.c" 2
...
# 47 "../../../ThirdParty/mbedTLS/library/ssl_cli.c" 2
# 59 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
...
# 97 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
                                    ...
                                    size_t *olen )
{
    ...
    *olen = 0;
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 111, "client hello, adding server name extension: %s", ssl->hostname );
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 117, "buffer too small" );
        return;
    }
# 147 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
        ...
        size_t *olen )
{
    ...
    *olen = 0;
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 182, "client hello, adding renegotiation extension" );

    if( end < p || (size_t)( end - p ) < 5 + ssl->verify_data_len )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 186, "buffer too small" );
        return;
    }
        ...
        size_t *olen )
{
    ...
    *olen = 0;
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 228, "client hello, adding signature_algorithms extension" );
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 242, "buffer too small" );
        return;
    }
...
# 280 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
        ...
        size_t *olen )
{
    ...
    *olen = 0;
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 313, "client hello, adding supported_elliptic_curves extension" );
...

    {
        ...
        if( info == 0 )
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 326, "invalid curve in ssl configuration" );
            return;
        }
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 335, "buffer too small" );
        return;
    }
        ...
        size_t *olen )
{
    ...
    *olen = 0;
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 378, "client hello, adding supported_point_formats extension" );

    if( end < p || (size_t)( end - p ) < 6 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 382, "buffer too small" );
        return;
    }
...
# 479 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
        ...
        size_t *olen )
{
    ...
    *olen = 0;
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 492, "client hello, adding max_fragment_length extension" );

    if( end < p || (size_t)( end - p ) < 5 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 496, "buffer too small" );
        return;
    }
        ...
        unsigned char *buf, size_t *olen )
{
    ...
    *olen = 0;
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 526, "client hello, adding truncated_hmac extension" );

    if( end < p || (size_t)( end - p ) < 4 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 530, "buffer too small" );
        return;
    }
        ...
        unsigned char *buf, size_t *olen )
{
    ...
    *olen = 0;
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 560, "client hello, adding encrypt_then_mac " "extension" );


    if( end < p || (size_t)( end - p ) < 4 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 564, "buffer too small" );
        return;
    }
                                       ...
                                       unsigned char *buf, size_t *olen )
{
    ...
    *olen = 0;
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 594, "client hello, adding extended_master_secret " "extension" );


    if( end < p || (size_t)( end - p ) < 4 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 598, "buffer too small" );
        return;
    }
        ...
        unsigned char *buf, size_t *olen )
{
    ...
    *olen = 0;
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 627, "client hello, adding session ticket extension" );

    if( end < p || (size_t)( end - p ) < 4 + tlen )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 631, "buffer too small" );
        return;
    }
    ...
    *olen = 4;
    ...
    if( ssl->session_negotiate->ticket == 0 || tlen == 0 )
    {
        return;
    }

    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 648, "sending session ticket of length %d", tlen );
                                ...
                                unsigned char *buf, size_t *olen )
{
    ...
    *olen = 0;
    ...
    if( ssl->conf->alpn_list == 0 )
    {
        return;
    }

    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 672, "client hello, adding alpn extension" );

    for( cur = ssl->conf->alpn_list; *cur != 0; cur++ )
        alpnlen += (unsigned char)( strlen( *cur ) & 0xFF ) + 1;

    if( end < p || (size_t)( end - p ) < 6 + alpnlen )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 679, "buffer too small" );
        return;
    }

    *p++ = (unsigned char)( ( 16 >> 8 ) & 0xFF );
    *p++ = (unsigned char)( ( 16 ) & 0xFF );
# 695 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    p += 4;
...
# 731 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    if( ssl->conf->transport == 1 &&
            ssl->handshake->verify_cookie != 0 )
    {
        return( 0 );
    }
# 747 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
...
# 769 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
                                     ...
                                     int min_minor_ver, int max_minor_ver )
{
    ...
    if( ssl->conf->arc4_disabled == 1 &&
        ...
        return( 1 );
# 801 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
...
static int ssl_write_client_hello( mbedtls_ssl_context *ssl )
{
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 825, "=> write client hello" );

    if( ssl->conf->f_rng == 0 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 829, "no RNG provided" );
        return( -0x7400 );
    }
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 844, "configured max major version is invalid, " "consider using mbedtls_ssl_config_defaults()" );

        return( -0x7100 );
    }
# 855 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    buf = ssl->out_msg;
    p = buf + 4;
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 863, "client hello, max version: [%d:%d]", buf[4], buf[5] );


    if( ( ret = ssl_generate_random( ssl ) ) != 0 )
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 867, "ssl_generate_random", ret );
        return( ret );
    }

    memcpy( p, ssl->handshake->randbytes, 32 );
    mbedtls_debug_print_buf( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 872, "client hello, random bytes", p, 32 );
    p += 32;
# 887 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    ...
    *p++ = (unsigned char) n;
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 925, "client hello, session id len.: %d", n );
    mbedtls_debug_print_buf( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 926, "client hello, session id", buf + 39, n );
    ...
    if( ssl->conf->transport == 1 )
    {
        if( ssl->handshake->verify_cookie == 0 )
        {
            mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 936, "no verify cookie to send" );
            *p++ = 0;
        }
        else
        {
            mbedtls_debug_print_buf( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 943, "client hello, cookie", ssl->handshake->verify_cookie, ssl->handshake->verify_cookie_len );
    ...
    for( i = 0; ciphersuites[i] != 0; i++ )
    {
        ...
        mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 973, "client hello, add ciphersuite: %04x", ciphersuites[i] );
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 985, "client hello, got %d ciphersuites (excluding SCSVs)", n );
    ...
    {
        mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 994, "adding EMPTY_RENEGOTIATION_INFO_SCSV" );
    ...
    {
        mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1004, "adding FALLBACK_SCSV" );
    ...
    *q++ = (unsigned char)( n << 1 );
    ...
    offer_compress = 0;
# 1027 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    if( ssl->conf->transport == 1 )
        offer_compress = 0;
    ...
    if( offer_compress )
    {
        mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1033, "client hello, compress len.: %d", 2 );
        mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1035, "client hello, compress alg.: %d %d", 1, 0 );
    ...
    {
        mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1043, "client hello, compress len.: %d", 1 );
        mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1045, "client hello, compress alg.: %d", 0 );
...
# 1089 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1122, "client hello, total extension length: %d", ext_len );
    ...
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1144, "mbedtls_ssl_write_handshake_msg", ret );
        return( ret );
    }
    ...
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1152, "mbedtls_ssl_flight_transmit", ret );
        return( ret );
    }


    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1157, "<= write client hello" );
        ...
        size_t len )
{
    ...
    if( ssl->renego_status != 0 )
    {
        ...
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1177, "non-matching renegotiation info" );
...

    {
        if( len != 1 || buf[0] != 0x00 )
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1188, "non-zero length renegotiation info" );
            mbedtls_ssl_send_alert_message( ssl, 2,
                                            40 );
            return( -0x7980 );
        }
        ...
        size_t len )
{
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1213, "non-matching max fragment length extension" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        40 );
        return( -0x7980 );
    }
        ...
        size_t len )
{
    if( ssl->conf->trunc_hmac == 0 ||
            len != 0 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1231, "non-matching truncated HMAC extension" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        40 );
        return( -0x7980 );
    }
        ...
        size_t len )
{
    if( ssl->conf->encrypt_then_mac == 0 ||
            ...
            len != 0 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1254, "non-matching encrypt-then-MAC extension" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        40 );
        return( -0x7980 );
    }
                                      ...
                                      size_t len )
{
    if( ssl->conf->extended_ms == 0 ||
            ...
            len != 0 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1277, "non-matching extended master secret extension" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        40 );
        return( -0x7980 );
    }
        ...
        size_t len )
{
    if( ssl->conf->session_tickets == 0 ||
            len != 0 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1299, "non-matching session ticket extension" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        40 );
        return( -0x7980 );
    }
        ...
        size_t len )
{
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1324, "bad server hello message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
        return( -0x7980 );
    }
    ...
    while( list_size > 0 )
    {
                ...
                p[0] == 1 )
        {
            ...
            mbedtls_debug_print_msg( ssl, 4, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1343, "point format selected: %d", p[0] );
            return( 0 );
        }
    ...
    mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1351, "no point format in common" );
    mbedtls_ssl_send_alert_message( ssl, 2,
                                    40 );
    return( -0x7980 );
}
# 1392 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
                               ...
                               const unsigned char *buf, size_t len )
{
    ...
    if( ssl->conf->alpn_list == 0 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1401, "non-matching ALPN extension" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        40 );
        return( -0x7980 );
    }
# 1418 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    if( len < 4 )
    {
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
    ...
    for( p = ssl->conf->alpn_list; *p != 0; p++ )
    {
    ...
    mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1452, "ALPN extension: no matching protocol" );
    mbedtls_ssl_send_alert_message( ssl, 2,
                                    40 );
    return( -0x7980 );
}
...
static int ssl_parse_hello_verify_request( mbedtls_ssl_context *ssl )
{
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1469, "=> parse hello verify request" );
    ...
    mbedtls_debug_print_buf( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1477, "server version", p, 2 );
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1490, "bad server version" );
    ...
    cookie_len = *p++;
    mbedtls_debug_print_buf( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1499, "cookie", p, cookie_len );

    if( ( ssl->in_msg + ssl->in_msglen ) - p < cookie_len )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1504, "cookie length does not match incoming message size" );
    ...
    if( ssl->handshake->verify_cookie == 0 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1515, "alloc failed (%d bytes)", cookie_len );
        return( -0x7F00 );
    }
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1528, "<= parse hello verify request" );
...
static int ssl_parse_server_hello( mbedtls_ssl_context *ssl )
{
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1550, "=> parse server hello" );
    ...
    if( ( ret = mbedtls_ssl_read_record( ssl, 1 ) ) != 0 )
    {
        ...
        mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1557, "mbedtls_ssl_read_record", ret );
        return( ret );
    }
    ...
    if( ssl->in_msgtype != 22 )
    {
        ...
        if( ssl->renego_status == 1 )
        {
            ...
            {
                mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1572, "renegotiation requested, " "but not honored by server" );

                return( -0x7700 );
            }

            mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1576, "non-handshake message during renego" );
        ...
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1583, "bad server hello message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        10 );
        return( -0x7700 );
    }
    ...
    if( ssl->conf->transport == 1 )
    {
        if( buf[0] == 3 )
        {
            mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1594, "received hello verify request" );
            mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1595, "<= parse server hello" );
    ...
    if( ssl->in_hslen < 38 + mbedtls_ssl_hs_hdr_len( ssl ) ||
            buf[0] != 2 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1611, "bad server hello message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
        return( -0x7980 );
    }
# 1628 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    buf += mbedtls_ssl_hs_hdr_len( ssl );

    mbedtls_debug_print_buf( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1630, "server hello, version", buf + 0, 2 );
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1643, "server version out of bounds - " " min: [%d:%d], server: [%d:%d], max: [%d:%d]", ssl->conf->min_major_ver, ssl->conf->min_minor_ver, ssl->major_ver, ssl->minor_ver, ssl->conf->max_major_ver, ssl->conf->max_minor_ver );
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1655, "server hello, current time: %lu", ( (uint32_t) buf[2] << 24 ) | ( (uint32_t) buf[3] << 16 ) | ( (uint32_t) buf[4] << 8 ) | ( (uint32_t) buf[5] ) );
    ...
    mbedtls_debug_print_buf( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1661, "server hello, random bytes", buf + 2, 32 );

    if( n > 32 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1665, "bad server hello message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
        return( -0x7980 );
    }
    ...
    if( ssl->in_hslen > mbedtls_ssl_hs_hdr_len( ssl ) + 39 + n )
    {
        ...
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1679, "bad server hello message" );
            mbedtls_ssl_send_alert_message( ssl, 2,
                                            50 );
            return( -0x7980 );
        }
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1691, "bad server hello message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
        return( -0x7980 );
    }
    ...
    comp = buf[37 + n];
# 1717 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    if( comp != 0 )

    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1720, "server hello, bad compression: %d", comp );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        47 );
        return( -0x7080 );
    }
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1733, "ciphersuite info for %04x not found", i );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        80 );
        return( -0x7100 );
    }
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1741, "server hello, session id len.: %d", n );
    mbedtls_debug_print_buf( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1742, "server hello, session id", buf + 35, n );
    ...
    else
    {
        ...
        {
            mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1772, "mbedtls_ssl_derive_keys", ret );
            mbedtls_ssl_send_alert_message( ssl, 2,
                                            80 );
            return( ret );
        }
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1780, "%s session has been resumed", ssl->handshake->resume ? "a" : "no" );


    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1782, "server hello, chosen ciphersuite: %04x", i );
    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1783, "server hello, compress alg.: %d", buf[37 + n] );
    ...
    while( 1 )
    {
        ...
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1793, "bad server hello message" );
            mbedtls_ssl_send_alert_message( ssl, 2,
                                            47 );
            return( -0x7980 );
        }
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1809, "bad server hello message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        47 );
        return( -0x7980 );
    }

    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1815, "server hello, chosen ciphersuite: %s", suite_info->name );
# 1825 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    if( comp != 0
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1831, "bad server hello message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        47 );
        return( -0x7980 );
    }
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1840, "server hello, total extension length: %d", ext_len );
    ...
    while( ext_len )
    {
        ...
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1851, "bad server hello message" );
            mbedtls_ssl_send_alert_message( ssl, 2,
                                            50 );
            return( -0x7980 );
        }
        ...
        {
        case 0xFF01:
            mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1860, "found renegotiation extension" );
        ...
        case 1:
            mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1873, "found max_fragment_length extension" );
        ...
        case 4:
            mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1886, "found truncated_hmac extension" );
        ...
        case 22:
            mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1899, "found encrypt_then_mac extension" );
        ...
        case 0x0017:
            mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1912, "found extended_master_secret extension" );
        ...
        case 35:
            mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1925, "found session_ticket extension" );
        ...
        case 11:
            mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1939, "found supported_point_formats extension" );
            ...
            break;
# 1965 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
        case 16:
            mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1966, "found alpn extension" );
        ...
        default:
            mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1976, "unknown extension found: %d (ignoring)", ext_id );
        ...
        if( ext_len > 0 && ext_len < 4 )
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1984, "bad server hello message" );
            return( -0x7980 );
        }
    }
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 1995, "legacy renegotiation, breaking off handshake" );
        handshake_failure = 1;
    }
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2003, "renegotiation_info extension missing (secure)" );
        handshake_failure = 1;
    }
    else if( ssl->renego_status == 1 &&
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2010, "legacy renegotiation not allowed" );
        handshake_failure = 1;
    }
    else if( ssl->renego_status == 1 &&
             ssl->secure_renegotiation == 0 &&
             renegotiation_info_seen == 1 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2017, "renegotiation_info extension present (legacy)" );
        handshake_failure = 1;
    }
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2029, "<= parse server hello" );
...
{
    int ret = -0x7080;
# 2050 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    if( ( ret = mbedtls_dhm_read_params( &ssl->handshake->dhm_ctx, p, end ) ) != 0 )
    {
        mbedtls_debug_print_ret( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2052, ( "mbedtls_dhm_read_params" ), ret );
        return( ret );
    }

    if( ssl->handshake->dhm_ctx.len * 8 < ssl->conf->dhm_min_bitlen )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2060, "DHM prime too short: %d < %d", ssl->handshake->dhm_ctx.len * 8, ssl->conf->dhm_min_bitlen );


        return( -0x7B00 );
    }

    mbedtls_debug_print_mpi( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2064, "DHM: P ", &ssl->handshake->dhm_ctx.P );
    mbedtls_debug_print_mpi( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2065, "DHM: G ", &ssl->handshake->dhm_ctx.G );
    mbedtls_debug_print_mpi( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2066, "DHM: GY", &ssl->handshake->dhm_ctx.GY );

    return( ret );
}
# 2078 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
static int ssl_check_server_ecdh_params( const mbedtls_ssl_context *ssl )
{
    ...
    if( curve_info == 0 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2091, "should never happen" );
        return( -0x6C00 );
    }

    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2095, "ECDH curve: %s", curve_info->name );
    ...
    mbedtls_debug_printf_ecdh( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2106, &ssl->handshake->ecdh_ctx, MBEDTLS_DEBUG_ECDH_QP );


    return( 0 );
}
# 2177 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
static int ssl_parse_server_ecdh_params( mbedtls_ssl_context *ssl,
        unsigned char **p,
        unsigned char *end )
{
    int ret = -0x7080;
# 2191 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    if( ( ret = mbedtls_ecdh_read_params( &ssl->handshake->ecdh_ctx,
                                          (const unsigned char **) p, end ) ) != 0 )
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2194, ( "mbedtls_ecdh_read_params" ), ret );
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2204, "bad server key exchange message (ECDHE curve)" );
        return( -0x7B00 );
    }
                                      ...
                                      unsigned char *end )
{
    ...
    if( end - (*p) < 2 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2231, "bad server key exchange message " "(psk_identity_hint length)" );
    ...
    *p += 2;
    ...
    if( end - (*p) < (int) len )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2240, "bad server key exchange message " "(psk_identity_hint length)" );
                                    ...
                                    size_t pms_offset )
{
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2272, "buffer too small for encrypted pms" );
        return( -0x6A00 );
    }
# 2283 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    mbedtls_ssl_write_version( ssl->conf->max_major_ver, ssl->conf->max_minor_ver,
                               ssl->conf->transport, p );

    if( ( ret = ssl->conf->f_rng( ssl->conf->p_rng, p + 2, 46 ) ) != 0 )
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2288, "f_rng", ret );
        return( ret );
    }
...
# 2309 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    if( ! mbedtls_pk_can_do( peer_pk, MBEDTLS_PK_RSA ) )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2311, "certificate key type mismatch" );
        return( -0x6D00 );
    }
    ...
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2321, "mbedtls_rsa_pkcs1_encrypt", ret );
        return( ret );
    }
        ...
        mbedtls_pk_type_t *pk_alg )
{
    ...
    *pk_alg = MBEDTLS_PK_NONE;
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2373, "Server used unsupported " "HashAlgorithm %d", *(p)[0] );
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2383, "server used unsupported " "SignatureAlgorithm %d", (*p)[1] );
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2393, "server used HashAlgorithm %d that was not offered", *(p)[0] );

        return( -0x7B00 );
    }

    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2397, "Server used SignatureAlgorithm %d", (*p)[1] );
    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2398, "Server used HashAlgorithm %d", (*p)[0] );
    *p += 2;
...
static int ssl_get_ecdh_params_from_cert( mbedtls_ssl_context *ssl )
{
    ...
    peer_pk = &ssl->handshake->peer_pubkey;
# 2428 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    if( ! mbedtls_pk_can_do( peer_pk, MBEDTLS_PK_ECKEY ) )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2430, "server key not ECDH capable" );
        return( -0x6D00 );
    }
    ...
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2439, ( "mbedtls_ecdh_get_params" ), ret );
        return( ret );
    }

    if( ssl_check_server_ecdh_params( ssl ) != 0 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2445, "bad server certificate (ECDH curve)" );
        return( -0x7A00 );
    }
...
static int ssl_parse_server_key_exchange( mbedtls_ssl_context *ssl )
{
    ...
    unsigned char *p = 0, *end = 0;

    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2468, "=> parse server key exchange" );


    if( ciphersuite_info->key_exchange == MBEDTLS_KEY_EXCHANGE_RSA )
    {
        mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2473, "<= skip parse server key exchange" );
        ssl->state++;
        return( 0 );
    }
    ((void) p);
            ...
            ciphersuite_info->key_exchange == MBEDTLS_KEY_EXCHANGE_ECDH_ECDSA )
    {
        ...
        {
            mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2488, "ssl_get_ecdh_params_from_cert", ret );
            mbedtls_ssl_send_alert_message( ssl, 2,
                                            40 );
            return( ret );
        }

        mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2494, "<= skip parse server key exchange" );
        ssl->state++;
        return( 0 );
    }
    ((void) p);
    ((void) end);
# 2511 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    if( ( ret = mbedtls_ssl_read_record( ssl, 1 ) ) != 0 )
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2513, "mbedtls_ssl_read_record", ret );
        return( ret );
    }

    if( ssl->in_msgtype != 22 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2519, "bad server key exchange message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        10 );
        return( -0x7700 );
    }
    ...
    if( ssl->in_msg[0] != 12 )
    {
        ...
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2541, "server key exchange message must " "not be skipped" );
    ...
    mbedtls_debug_print_buf( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2556, "server key exchange", p, end - p );
            ...
            ciphersuite_info->key_exchange == MBEDTLS_KEY_EXCHANGE_ECDHE_PSK )
    {
        ...
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2566, "bad server key exchange message" );
            mbedtls_ssl_send_alert_message( ssl, 2,
                                            47 );
            return( -0x7B00 );
        }
    ...
    if( ciphersuite_info->key_exchange == MBEDTLS_KEY_EXCHANGE_PSK ||
                ...
                ciphersuite_info->key_exchange == MBEDTLS_KEY_EXCHANGE_DHE_PSK )
        {
            ...
            {
                mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2589, "bad server key exchange message" );
                mbedtls_ssl_send_alert_message( ssl, 2,
                                                47 );
                return( -0x7B00 );
            }
...
# 2619 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
                        ...
                        ciphersuite_info->key_exchange == MBEDTLS_KEY_EXCHANGE_ECDHE_ECDSA )
                {
                    ...
                    {
                        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2625, "bad server key exchange message" );
                        mbedtls_ssl_send_alert_message( ssl, 2,
                                                        47 );
                        return( -0x7B00 );
                    }
...
# 2650 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
                    {
                        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2651, "should never happen" );
                        return( -0x6C00 );
                    }
    ...
    if( mbedtls_ssl_ciphersuite_uses_server_signature( ciphersuite_info ) )
    {
        ...
        if( ssl->minor_ver == 3 )
        {
            if( ssl_parse_signature_algorithm( ssl, &p, end,
                                               &md_alg, &pk_alg ) != 0 )
            {
                mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2677, "bad server key exchange message" );
                mbedtls_ssl_send_alert_message( ssl, 2,
                                                47 );
                return( -0x7B00 );
            }
            ...
            {
                mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2685, "bad server key exchange message" );
                mbedtls_ssl_send_alert_message( ssl, 2,
                                                47 );
                return( -0x7B00 );
            }
            ...
            {
                mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2706, "should never happen" );
                return( -0x6C00 );
            }
        ...
        if( p > end - 2 )
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2716, "bad server key exchange message" );
            mbedtls_ssl_send_alert_message( ssl, 2,
                                            50 );
            return( -0x7B00 );
        }
        ...
        if( p != end - sig_len )
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2726, "bad server key exchange message" );
            mbedtls_ssl_send_alert_message( ssl, 2,
                                            50 );
            return( -0x7B00 );
        }

        mbedtls_debug_print_buf( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2732, "signature", p, sig_len );
        ...
        if( md_alg == MBEDTLS_MD_NONE )
        {
            ...
            {
                mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2764, "should never happen" );
                return( -0x6C00 );
            }

        mbedtls_debug_print_buf( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2768, "parameters hash", hash, hashlen );


        peer_pk = &ssl->handshake->peer_pubkey;
# 2785 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
        if( !mbedtls_pk_can_do( peer_pk, pk_alg ) )
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2787, "bad server key exchange message" );
            mbedtls_ssl_send_alert_message( ssl, 2,
                                            40 );
            return( -0x6D00 );
        }
                    ...
                    md_alg, hash, hashlen, p, sig_len, rs_ctx ) ) != 0 )
        {
                ...
                mbedtls_ssl_send_alert_message( ssl, 2,
                                                51 );
            mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2806, "mbedtls_pk_verify", ret );
...
exit:
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2826, "<= parse server key exchange" );

    return( 0 );
}
# 2850 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
static int ssl_parse_certificate_request( mbedtls_ssl_context *ssl )
{
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2859, "=> parse certificate request" );

    if( ! mbedtls_ssl_ciphersuite_cert_req_allowed( ciphersuite_info ) )
    {
        mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2863, "<= skip parse certificate request" );
        ssl->state++;
        return( 0 );
    }
    ...
    if( ( ret = mbedtls_ssl_read_record( ssl, 1 ) ) != 0 )
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2870, "mbedtls_ssl_read_record", ret );
        return( ret );
    }

    if( ssl->in_msgtype != 22 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2876, "bad certificate request message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        10 );
        return( -0x7700 );
    }
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2886, "got %s certificate request", ssl->client_auth ? "a" : "no" );
...
# 2919 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    buf = ssl->in_msg;


    if( ssl->in_hslen <= mbedtls_ssl_hs_hdr_len( ssl ) )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2924, "bad certificate request message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
        return( -0x7A80 );
    }
    ...
    n = cert_type_len;
# 2942 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    if( ssl->in_hslen <= mbedtls_ssl_hs_hdr_len( ssl ) + 2 + n )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2944, "bad certificate request message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
        return( -0x7A80 );
    }
    ...
    if( ssl->minor_ver == 3 )
    {
        ...
        size_t i;
# 2973 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
        if( ssl->in_hslen <= mbedtls_ssl_hs_hdr_len( ssl ) + 3 + n + sig_alg_len )
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2975, "bad certificate request message" );
            mbedtls_ssl_send_alert_message( ssl, 2,
                                            50 );
            return( -0x7A80 );
        }
        ...
        {
            mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 2986, "Supported Signature Algorithm found: %d" ",%d", sig_alg[i], sig_alg[i + 1] );
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3001, "bad certificate request message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
        return( -0x7A80 );
    }
...
exit:
    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3008, "<= parse certificate request" );
...
static int ssl_parse_server_hello_done( mbedtls_ssl_context *ssl )
{
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3018, "=> parse server hello done" );

    if( ( ret = mbedtls_ssl_read_record( ssl, 1 ) ) != 0 )
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3022, "mbedtls_ssl_read_record", ret );
        return( ret );
    }

    if( ssl->in_msgtype != 22 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3028, "bad server hello done message" );
        return( -0x7700 );
    }
    ...
    if( ssl->in_hslen != mbedtls_ssl_hs_hdr_len( ssl ) ||
            ssl->in_msg[0] != 14 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3035, "bad server hello done message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
        return( -0x7B80 );
    }
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3048, "<= parse server hello done" );
...
static int ssl_write_client_key_exchange( mbedtls_ssl_context *ssl )
{
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3062, "=> write client key exchange" );
    ...
    if( ciphersuite_info->key_exchange == MBEDTLS_KEY_EXCHANGE_DHE_RSA )
    {
        ...
        if( ret != 0 )
        {
            mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3082, "mbedtls_dhm_make_public", ret );
            return( ret );
        }

        mbedtls_debug_print_mpi( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3086, "DHM: X ", &ssl->handshake->dhm_ctx.X );
        mbedtls_debug_print_mpi( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3087, "DHM: GX", &ssl->handshake->dhm_ctx.GX );
        ...
        if( ( ret = mbedtls_dhm_calc_secret( &ssl->handshake->dhm_ctx,
                                             ...
                                             ssl->conf->f_rng, ssl->conf->p_rng ) ) != 0 )
        {
            mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3095, "mbedtls_dhm_calc_secret", ret );
            return( ret );
        }

        mbedtls_debug_print_mpi( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3099, "DHM: K ", &ssl->handshake->dhm_ctx.K );
    }
    else
# 3220 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
            if( ciphersuite_info->key_exchange == MBEDTLS_KEY_EXCHANGE_ECDHE_RSA ||
                    ciphersuite_info->key_exchange == MBEDTLS_KEY_EXCHANGE_ECDHE_ECDSA ||
                    ...
                    ciphersuite_info->key_exchange == MBEDTLS_KEY_EXCHANGE_ECDH_ECDSA )
            {
                ...
                header_len = 4;
# 3240 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
                ...
                if( ret != 0 )
                {
                    mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3246, "mbedtls_ecdh_make_public", ret );
                ...
                mbedtls_debug_printf_ecdh( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3255, &ssl->handshake->ecdh_ctx, MBEDTLS_DEBUG_ECDH_Q );
# 3268 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
                if( ( ret = mbedtls_ecdh_calc_secret( &ssl->handshake->ecdh_ctx,
                                                      ...
                                                      ssl->conf->f_rng, ssl->conf->p_rng ) ) != 0 )
                {
                    mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3274, "mbedtls_ecdh_calc_secret", ret );
                ...
                mbedtls_debug_printf_ecdh( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3283, &ssl->handshake->ecdh_ctx, MBEDTLS_DEBUG_ECDH_Z );
                ...
                if( mbedtls_ssl_ciphersuite_uses_psk( ciphersuite_info ) )
                {
                    ...
                    {
                        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3310, "psk identity too long or " "SSL buffer too short" );
                    ...
                    if( ciphersuite_info->key_exchange == MBEDTLS_KEY_EXCHANGE_PSK )
                    {
                        ...
                        if( ciphersuite_info->key_exchange == MBEDTLS_KEY_EXCHANGE_RSA_PSK )
                        {
                            ...
                            {
# 3356 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
                                content_len = ssl->handshake->dhm_ctx.len;

                                if( header_len + 2 + content_len >
                                        16384 )
                                {
                                    mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3362, "psk identity or DHM size too long" " or SSL buffer too short" );
                                ...
                                if( ret != 0 )
                                {
                                    mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3375, "mbedtls_dhm_make_public", ret );
                                    return( ret );
                                }
                            }
                            else
                                ...
                                {
# 3393 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
                                    ret = mbedtls_ecdh_make_public( &ssl->handshake->ecdh_ctx,
                                                                    &content_len,
                                    ...
                                    if( ret != 0 )
                                    {
                                        mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3400, "mbedtls_ecdh_make_public", ret );
                                        return( ret );
                                    }

                                    mbedtls_debug_printf_ecdh( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3405, &ssl->handshake->ecdh_ctx, MBEDTLS_DEBUG_ECDH_Q );

                                }
                                else

                                {
                                    mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3410, "should never happen" );
                                    return( -0x6C00 );
                                }
# 3425 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
                        if( ( ret = mbedtls_ssl_psk_derive_premaster( ssl,
                                    ciphersuite_info->key_exchange ) ) != 0 )
                        {
                            mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3428, "mbedtls_ssl_psk_derive_premaster", ret );
                            return( ret );
                        }
                }
                else
...
# 3471 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
                        {
                            ((void) ciphersuite_info);
                            mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3473, "should never happen" );
                            return( -0x6C00 );
                        }
    ...
    if( ( ret = mbedtls_ssl_write_handshake_msg( ssl ) ) != 0 )
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3485, "mbedtls_ssl_write_handshake_msg", ret );
        return( ret );
    }

    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3489, "<= write client key exchange" );

    return( 0 );
}
# 3520 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
static int ssl_write_certificate_verify( mbedtls_ssl_context *ssl )
{
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3532, "=> write certificate verify" );
# 3542 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    if( ( ret = mbedtls_ssl_derive_keys( ssl ) ) != 0 )
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3544, "mbedtls_ssl_derive_keys", ret );
        return( ret );
    }

    if( !mbedtls_ssl_ciphersuite_cert_req_allowed( ciphersuite_info ) )
    {
        mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3550, "<= skip write certificate verify" );
        ssl->state++;
        return( 0 );
    }

    if( ssl->client_auth == 0 || mbedtls_ssl_own_cert( ssl ) == 0 )
    {
        mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3557, "<= skip write certificate verify" );
        ssl->state++;
        return( 0 );
    }

    if( mbedtls_ssl_own_key( ssl ) == 0 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3564, "got no private key for certificate" );
        return( -0x7600 );
    }
# 3578 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    ...
    if( ssl->minor_ver != 3 )
    {
# 3596 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
        hashlen = 36;
        md_alg = MBEDTLS_MD_NONE;
        ...
        if( ssl->minor_ver == 3 )
        {
# 3630 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
        ...
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3650, "should never happen" );
            return( -0x6C00 );
        }
    ...
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3664, "mbedtls_pk_sign", ret );
    ...
    if( ( ret = mbedtls_ssl_write_handshake_msg( ssl ) ) != 0 )
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3683, "mbedtls_ssl_write_handshake_msg", ret );
        return( ret );
    }

    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3687, "<= write certificate verify" );
...
static int ssl_parse_new_session_ticket( mbedtls_ssl_context *ssl )
{
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3702, "=> parse new session ticket" );

    if( ( ret = mbedtls_ssl_read_record( ssl, 1 ) ) != 0 )
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3706, "mbedtls_ssl_read_record", ret );
        return( ret );
    }

    if( ssl->in_msgtype != 22 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3712, "bad new session ticket message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        10 );
        return( -0x7700 );
    }
# 3728 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    if( ssl->in_msg[0] != 4 ||
            ssl->in_hslen < 6 + mbedtls_ssl_hs_hdr_len( ssl ) )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3731, "bad new session ticket message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
        return( -0x6E00 );
    }
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3746, "bad new session ticket message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
        return( -0x6E00 );
    }

    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3752, "ticket length: %d", ticket_len );
    ...
    if( ( ticket = calloc( 1, ticket_len ) ) == 0 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3782, "ticket alloc failed" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        80 );
        return( -0x7F00 );
    }
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3799, "ticket in use, discarding session id" );
    ssl->session_negotiate->id_len = 0;

    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3802, "<= parse new session ticket" );
...
int mbedtls_ssl_handshake_client_step( mbedtls_ssl_context *ssl )
{
    ...
    if( ssl->state == MBEDTLS_SSL_HANDSHAKE_OVER || ssl->handshake == 0 )
        return( -0x7100 );

    mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3818, "client state: %d", ssl->state );
    ...
    case MBEDTLS_SSL_CLIENT_HELLO:
        ...
        break;
# 3862 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    ...
    case MBEDTLS_SSL_SERVER_HELLO_DONE:
        ...
        break;
# 3889 "../../../ThirdParty/mbedTLS/library/ssl_cli.c"
    ...
    case MBEDTLS_SSL_FLUSH_BUFFERS:
        mbedtls_debug_print_msg( ssl, 2, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3929, "handshake: done" );
    ...
    default:
        mbedtls_debug_print_msg( ssl, 1, "../../../ThirdParty/mbedTLS/library/ssl_cli.c", 3938, "invalid state %d", ssl->state );
        return( -0x7100 );
    }
