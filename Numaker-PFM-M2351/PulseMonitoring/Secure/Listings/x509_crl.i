# 1 "../../../ThirdParty/mbedTLS/library/x509_crl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../ThirdParty/mbedTLS/library/x509_crl.c" 2
# 33 "../../../ThirdParty/mbedTLS/library/x509_crl.c"
...
# 34 "../../../ThirdParty/mbedTLS/library/x509_crl.c" 2
...
# 34 "../../../ThirdParty/mbedTLS/include/mbedtls\\x509_crl.h" 2
...
# 41 "../../../ThirdParty/mbedTLS/library/x509_crl.c" 2
...
# 42 "../../../ThirdParty/mbedTLS/library/x509_crl.c" 2
...
# 45 "../../../ThirdParty/mbedTLS/library/x509_crl.c" 2
...
# 48 "../../../ThirdParty/mbedTLS/library/x509_crl.c" 2
...
# 52 "../../../ThirdParty/mbedTLS/library/x509_crl.c" 2
# 73 "../../../ThirdParty/mbedTLS/library/x509_crl.c"
...
# 100 "../../../ThirdParty/mbedTLS/library/x509_crl.c"
                                ...
                                const unsigned char *buf, size_t buflen )
{
    ...
    while( crl->version != 0 && crl->next != 0 )
        crl = crl->next;

    if( crl->version != 0 && crl->next == 0 )
    {
...
# 470 "../../../ThirdParty/mbedTLS/library/x509_crl.c"
...
# 630 "../../../ThirdParty/mbedTLS/library/x509_crl.c"
int mbedtls_x509_crl_info( char *buf, size_t size, const char *prefix,
                           const mbedtls_x509_crl *crl )
{
    int ret;
