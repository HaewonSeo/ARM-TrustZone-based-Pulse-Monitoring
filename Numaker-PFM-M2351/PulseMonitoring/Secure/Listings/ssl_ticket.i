# 1 "../../../ThirdParty/mbedTLS/library/ssl_ticket.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../ThirdParty/mbedTLS/library/ssl_ticket.c" 2
# 23 "../../../ThirdParty/mbedTLS/library/ssl_ticket.c"
...
# 24 "../../../ThirdParty/mbedTLS/library/ssl_ticket.c" 2
...
# 32 "../../../ThirdParty/mbedTLS/library/ssl_ticket.c" 2
...
# 1 "../../../ThirdParty/mbedTLS/include/mbedtls\\ssl_ticket.h" 1
# 28 "../../../ThirdParty/mbedTLS/include/mbedtls\\ssl_ticket.h"
# 1 "../../../ThirdParty/mbedTLS/include/mbedtls/config.h" 1
# 29 "../../../ThirdParty/mbedTLS/include/mbedtls\\ssl_ticket.h" 2
# 39 "../../../ThirdParty/mbedTLS/include/mbedtls\\ssl_ticket.h"
...
# 40 "../../../ThirdParty/mbedTLS/include/mbedtls\\ssl_ticket.h" 2
# 53 "../../../ThirdParty/mbedTLS/include/mbedtls\\ssl_ticket.h"
...
# 88 "../../../ThirdParty/mbedTLS/include/mbedtls\\ssl_ticket.h"
void mbedtls_ssl_ticket_init( mbedtls_ssl_ticket_context *ctx );
# 112 "../../../ThirdParty/mbedTLS/include/mbedtls\\ssl_ticket.h"
...
# 39 "../../../ThirdParty/mbedTLS/library/ssl_ticket.c" 2
...
# 42 "../../../ThirdParty/mbedTLS/library/ssl_ticket.c" 2
...
# 73 "../../../ThirdParty/mbedTLS/library/ssl_ticket.c"
...
static int ssl_ticket_update_keys( mbedtls_ssl_ticket_context *ctx )
{
    ...
    ((void) ctx);
# 125 "../../../ThirdParty/mbedTLS/library/ssl_ticket.c"
    return( 0 );
}
                              ...
                              uint32_t lifetime )
{
    ...
    if( cipher_info->key_bitlen > 8 * 32 )
        return( -0x7100 );
# 166 "../../../ThirdParty/mbedTLS/library/ssl_ticket.c"
        if( ( ret = mbedtls_cipher_setup( &ctx->keys[0].ctx, cipher_info ) ) != 0 )
            return( ret );
# 176 "../../../ThirdParty/mbedTLS/library/ssl_ticket.c"
...
# 201 "../../../ThirdParty/mbedTLS/library/ssl_ticket.c"
...
# 246 "../../../ThirdParty/mbedTLS/library/ssl_ticket.c"
                             ...
                             const unsigned char *buf, size_t len )
{
    ...
    session->ticket = 0;
# 341 "../../../ThirdParty/mbedTLS/library/ssl_ticket.c"
    if( 1 > (size_t)( end - p ) )
        return( -0x7100 );
    ...
    if( cert_digest_len != 0 )
    {
        ...
        session->peer_cert_digest = calloc( 1, cert_digest_len );
        if( session->peer_cert_digest == 0 )
            return( -0x7F00 );
...
# 385 "../../../ThirdParty/mbedTLS/library/ssl_ticket.c"
                              ...
                              size_t len )
{
    ...
    if( ( key = ssl_ticket_select_key( ctx, key_name ) ) == 0 )
    {
    ...
    if( ( ret = ssl_load_session( session, ticket, clear_len ) ) != 0 )
        goto cleanup;
# 571 "../../../ThirdParty/mbedTLS/library/ssl_ticket.c"
cleanup:
