# 1 "../../../ThirdParty/mbedTLS/library/oid.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../ThirdParty/mbedTLS/library/oid.c" 2
# 25 "../../../ThirdParty/mbedTLS/library/oid.c"
...
# 26 "../../../ThirdParty/mbedTLS/library/oid.c" 2
...
# 33 "../../../ThirdParty/mbedTLS/library/oid.c" 2
...
# 36 "../../../ThirdParty/mbedTLS/library/oid.c" 2
...
# 37 "../../../ThirdParty/mbedTLS/library/oid.c" 2
...
# 40 "../../../ThirdParty/mbedTLS/library/oid.c" 2
# 159 "../../../ThirdParty/mbedTLS/library/oid.c"
typedef struct {
...
static const oid_x520_attr_t * oid_x520_attr_from_asn1( const mbedtls_asn1_buf *oid ) { const oid_x520_attr_t *p = oid_x520_attr_type; const mbedtls_oid_descriptor_t *cur = (const mbedtls_oid_descriptor_t *) p; if( p == 0 || oid == 0 ) return( 0 ); while( cur->asn1 != 0 ) { if( cur->asn1_len == oid->len && memcmp( cur->asn1, oid->p, oid->len ) == 0 ) { return( p ); } p++; cur = (const mbedtls_oid_descriptor_t *) p; } return( 0 ); }
int mbedtls_oid_get_attr_short_name( const mbedtls_asn1_buf *oid, const char * * short_name ) { const oid_x520_attr_t *data = oid_x520_attr_from_asn1( oid ); if( data == 0 ) return( -0x002E ); *short_name = data->short_name; return( 0 ); }
...
static const oid_x509_ext_t * oid_x509_ext_from_asn1( const mbedtls_asn1_buf *oid ) { const oid_x509_ext_t *p = oid_x509_ext; const mbedtls_oid_descriptor_t *cur = (const mbedtls_oid_descriptor_t *) p; if( p == 0 || oid == 0 ) return( 0 ); while( cur->asn1 != 0 ) { if( cur->asn1_len == oid->len && memcmp( cur->asn1, oid->p, oid->len ) == 0 ) { return( p ); } p++; cur = (const mbedtls_oid_descriptor_t *) p; } return( 0 ); }
int mbedtls_oid_get_x509_ext_type( const mbedtls_asn1_buf *oid, int * ext_type ) { const oid_x509_ext_t *data = oid_x509_ext_from_asn1( oid ); if( data == 0 ) return( -0x002E ); *ext_type = data->ext_type; return( 0 ); }
...
static const mbedtls_oid_descriptor_t * oid_ext_key_usage_from_asn1( const mbedtls_asn1_buf *oid ) { const mbedtls_oid_descriptor_t *p = oid_ext_key_usage; const mbedtls_oid_descriptor_t *cur = (const mbedtls_oid_descriptor_t *) p; if( p == 0 || oid == 0 ) return( 0 ); while( cur->asn1 != 0 ) { if( cur->asn1_len == oid->len && memcmp( cur->asn1, oid->p, oid->len ) == 0 ) { return( p ); } p++; cur = (const mbedtls_oid_descriptor_t *) p; } return( 0 ); }
int mbedtls_oid_get_extended_key_usage( const mbedtls_asn1_buf *oid, const char * * description ) { const mbedtls_oid_descriptor_t *data = oid_ext_key_usage_from_asn1( oid ); if( data == 0 ) return( -0x002E ); *description = data->description; return( 0 ); }
...
{
# 331 "../../../ThirdParty/mbedTLS/library/oid.c"
    {
...
static const oid_sig_alg_t * oid_sig_alg_from_asn1( const mbedtls_asn1_buf *oid ) { const oid_sig_alg_t *p = oid_sig_alg; const mbedtls_oid_descriptor_t *cur = (const mbedtls_oid_descriptor_t *) p; if( p == 0 || oid == 0 ) return( 0 ); while( cur->asn1 != 0 ) { if( cur->asn1_len == oid->len && memcmp( cur->asn1, oid->p, oid->len ) == 0 ) { return( p ); } p++; cur = (const mbedtls_oid_descriptor_t *) p; } return( 0 ); }
int mbedtls_oid_get_sig_alg_desc( const mbedtls_asn1_buf *oid, const char * * description ) { const oid_sig_alg_t *data = oid_sig_alg_from_asn1( oid ); if( data == 0 ) return( -0x002E ); *description = data->descriptor.description; return( 0 ); }
int mbedtls_oid_get_sig_alg( const mbedtls_asn1_buf *oid, mbedtls_md_type_t * md_alg, mbedtls_pk_type_t * pk_alg ) { const oid_sig_alg_t *data = oid_sig_alg_from_asn1( oid ); if( data == 0 ) return( -0x002E ); *md_alg = data->md_alg; *pk_alg = data->pk_alg; return( 0 ); }
int mbedtls_oid_get_oid_by_sig_alg( mbedtls_pk_type_t pk_alg, mbedtls_md_type_t md_alg, const char **oid , size_t *olen ) { const oid_sig_alg_t *cur = oid_sig_alg; while( cur->descriptor.asn1 != 0 ) { if( cur->pk_alg == pk_alg && cur->md_alg == md_alg ) { *oid = cur->descriptor.asn1; *olen = cur->descriptor.asn1_len; return( 0 ); } cur++; } return( -0x002E ); }
...
static const oid_pk_alg_t * oid_pk_alg_from_asn1( const mbedtls_asn1_buf *oid ) { const oid_pk_alg_t *p = oid_pk_alg; const mbedtls_oid_descriptor_t *cur = (const mbedtls_oid_descriptor_t *) p; if( p == 0 || oid == 0 ) return( 0 ); while( cur->asn1 != 0 ) { if( cur->asn1_len == oid->len && memcmp( cur->asn1, oid->p, oid->len ) == 0 ) { return( p ); } p++; cur = (const mbedtls_oid_descriptor_t *) p; } return( 0 ); }
int mbedtls_oid_get_pk_alg( const mbedtls_asn1_buf *oid, mbedtls_pk_type_t * pk_alg ) { const oid_pk_alg_t *data = oid_pk_alg_from_asn1( oid ); if( data == 0 ) return( -0x002E ); *pk_alg = data->pk_alg; return( 0 ); }
int mbedtls_oid_get_oid_by_pk_alg( mbedtls_pk_type_t pk_alg, const char **oid, size_t *olen ) { const oid_pk_alg_t *cur = oid_pk_alg; while( cur->descriptor.asn1 != 0 ) { if( cur->pk_alg == pk_alg ) { *oid = cur->descriptor.asn1; *olen = cur->descriptor.asn1_len; return( 0 ); } cur++; } return( -0x002E ); }
...
static const oid_ecp_grp_t * oid_grp_id_from_asn1( const mbedtls_asn1_buf *oid ) { const oid_ecp_grp_t *p = oid_ecp_grp; const mbedtls_oid_descriptor_t *cur = (const mbedtls_oid_descriptor_t *) p; if( p == 0 || oid == 0 ) return( 0 ); while( cur->asn1 != 0 ) { if( cur->asn1_len == oid->len && memcmp( cur->asn1, oid->p, oid->len ) == 0 ) { return( p ); } p++; cur = (const mbedtls_oid_descriptor_t *) p; } return( 0 ); }
int mbedtls_oid_get_ec_grp( const mbedtls_asn1_buf *oid, mbedtls_ecp_group_id * grp_id ) { const oid_ecp_grp_t *data = oid_grp_id_from_asn1( oid ); if( data == 0 ) return( -0x002E ); *grp_id = data->grp_id; return( 0 ); }
int mbedtls_oid_get_oid_by_ec_grp( mbedtls_ecp_group_id grp_id, const char **oid, size_t *olen ) { const oid_ecp_grp_t *cur = oid_ecp_grp; while( cur->descriptor.asn1 != 0 ) { if( cur->grp_id == grp_id ) { *oid = cur->descriptor.asn1; *olen = cur->descriptor.asn1_len; return( 0 ); } cur++; } return( -0x002E ); }
...
static const oid_cipher_alg_t * oid_cipher_alg_from_asn1( const mbedtls_asn1_buf *oid ) { const oid_cipher_alg_t *p = oid_cipher_alg; const mbedtls_oid_descriptor_t *cur = (const mbedtls_oid_descriptor_t *) p; if( p == 0 || oid == 0 ) return( 0 ); while( cur->asn1 != 0 ) { if( cur->asn1_len == oid->len && memcmp( cur->asn1, oid->p, oid->len ) == 0 ) { return( p ); } p++; cur = (const mbedtls_oid_descriptor_t *) p; } return( 0 ); }
int mbedtls_oid_get_cipher_alg( const mbedtls_asn1_buf *oid, mbedtls_cipher_type_t * cipher_alg ) { const oid_cipher_alg_t *data = oid_cipher_alg_from_asn1( oid ); if( data == 0 ) return( -0x002E ); *cipher_alg = data->cipher_alg; return( 0 ); }
...
{
# 588 "../../../ThirdParty/mbedTLS/library/oid.c"
    {
...
static const oid_md_alg_t * oid_md_alg_from_asn1( const mbedtls_asn1_buf *oid ) { const oid_md_alg_t *p = oid_md_alg; const mbedtls_oid_descriptor_t *cur = (const mbedtls_oid_descriptor_t *) p; if( p == 0 || oid == 0 ) return( 0 ); while( cur->asn1 != 0 ) { if( cur->asn1_len == oid->len && memcmp( cur->asn1, oid->p, oid->len ) == 0 ) { return( p ); } p++; cur = (const mbedtls_oid_descriptor_t *) p; } return( 0 ); }
int mbedtls_oid_get_md_alg( const mbedtls_asn1_buf *oid, mbedtls_md_type_t * md_alg ) { const oid_md_alg_t *data = oid_md_alg_from_asn1( oid ); if( data == 0 ) return( -0x002E ); *md_alg = data->md_alg; return( 0 ); }
int mbedtls_oid_get_oid_by_md( mbedtls_md_type_t md_alg, const char **oid, size_t *olen ) { const oid_md_alg_t *cur = oid_md_alg; while( cur->descriptor.asn1 != 0 ) { if( cur->md_alg == md_alg ) { *oid = cur->descriptor.asn1; *olen = cur->descriptor.asn1_len; return( 0 ); } cur++; } return( -0x002E ); }
...
static const oid_md_hmac_t * oid_md_hmac_from_asn1( const mbedtls_asn1_buf *oid ) { const oid_md_hmac_t *p = oid_md_hmac; const mbedtls_oid_descriptor_t *cur = (const mbedtls_oid_descriptor_t *) p; if( p == 0 || oid == 0 ) return( 0 ); while( cur->asn1 != 0 ) { if( cur->asn1_len == oid->len && memcmp( cur->asn1, oid->p, oid->len ) == 0 ) { return( p ); } p++; cur = (const mbedtls_oid_descriptor_t *) p; } return( 0 ); }
int mbedtls_oid_get_md_hmac( const mbedtls_asn1_buf *oid, mbedtls_md_type_t * md_hmac ) { const oid_md_hmac_t *data = oid_md_hmac_from_asn1( oid ); if( data == 0 ) return( -0x002E ); *md_hmac = data->md_hmac; return( 0 ); }
...
static const oid_pkcs12_pbe_alg_t * oid_pkcs12_pbe_alg_from_asn1( const mbedtls_asn1_buf *oid ) { const oid_pkcs12_pbe_alg_t *p = oid_pkcs12_pbe_alg; const mbedtls_oid_descriptor_t *cur = (const mbedtls_oid_descriptor_t *) p; if( p == 0 || oid == 0 ) return( 0 ); while( cur->asn1 != 0 ) { if( cur->asn1_len == oid->len && memcmp( cur->asn1, oid->p, oid->len ) == 0 ) { return( p ); } p++; cur = (const mbedtls_oid_descriptor_t *) p; } return( 0 ); }
int mbedtls_oid_get_pkcs12_pbe_alg( const mbedtls_asn1_buf *oid, mbedtls_md_type_t * md_alg, mbedtls_cipher_type_t * cipher_alg ) { const oid_pkcs12_pbe_alg_t *data = oid_pkcs12_pbe_alg_from_asn1( oid ); if( data == 0 ) return( -0x002E ); *md_alg = data->md_alg; *cipher_alg = data->cipher_alg; return( 0 ); }
# 715 "../../../ThirdParty/mbedTLS/library/oid.c"
