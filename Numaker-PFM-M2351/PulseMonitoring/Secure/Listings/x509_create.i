# 1 "../../../ThirdParty/mbedTLS/library/x509_create.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../ThirdParty/mbedTLS/library/x509_create.c" 2
# 23 "../../../ThirdParty/mbedTLS/library/x509_create.c"
...
# 24 "../../../ThirdParty/mbedTLS/library/x509_create.c" 2
...
# 31 "../../../ThirdParty/mbedTLS/library/x509_create.c" 2
...
mbedtls_asn1_named_data *mbedtls_asn1_store_named_data( mbedtls_asn1_named_data **list,
                                        ...
                                        size_t val_len );
# 32 "../../../ThirdParty/mbedTLS/library/x509_create.c" 2
...
# 33 "../../../ThirdParty/mbedTLS/library/x509_create.c" 2
...
# 35 "../../../ThirdParty/mbedTLS/library/x509_create.c" 2
...
static const x509_attr_descriptor_t *x509_attr_descr_from_name( const char *name, size_t name_len )
{
    ...
    for( cur = x509_attrs; cur->name != 0; cur++ )
...
int mbedtls_x509_string_to_names( mbedtls_asn1_named_data **head, const char *name )
{
    ...
    const char *oid = 0;
    const x509_attr_descriptor_t* attr_descr = 0;
    int in_tag = 1;
    char data[256];
    char *d = data;
    ...
    while( c <= end )
    {
        if( in_tag && *c == '=' )
        {
            if( ( attr_descr = x509_attr_descr_from_name( s, c - s ) ) == 0 )
            {
                ret = -0x2100;
                goto exit;
            }
...
# 270 "../../../ThirdParty/mbedTLS/library/x509_create.c"
...
# 391 "../../../ThirdParty/mbedTLS/library/x509_create.c"
int mbedtls_x509_write_extensions( unsigned char **p, unsigned char *start,
                                   mbedtls_asn1_named_data *first )
{
    int ret;
