# 1 "../../../ThirdParty/mbedTLS/library/platform.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../ThirdParty/mbedTLS/library/platform.c" 2
# 23 "../../../ThirdParty/mbedTLS/library/platform.c"
...
# 24 "../../../ThirdParty/mbedTLS/library/platform.c" 2
...
# 31 "../../../ThirdParty/mbedTLS/library/platform.c" 2
...
# 32 "../../../ThirdParty/mbedTLS/library/platform.c" 2
# 375 "../../../ThirdParty/mbedTLS/library/platform.c"
int mbedtls_platform_setup( mbedtls_platform_context *ctx )
{
    (void)ctx;
