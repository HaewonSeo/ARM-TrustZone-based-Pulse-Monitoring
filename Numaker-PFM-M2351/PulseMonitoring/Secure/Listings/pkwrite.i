# 1 "../../../ThirdParty/mbedTLS/library/pkwrite.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../ThirdParty/mbedTLS/library/pkwrite.c" 2
# 23 "../../../ThirdParty/mbedTLS/library/pkwrite.c"
...
# 24 "../../../ThirdParty/mbedTLS/library/pkwrite.c" 2
...
# 31 "../../../ThirdParty/mbedTLS/library/pkwrite.c" 2
...
mbedtls_asn1_named_data *mbedtls_asn1_store_named_data( mbedtls_asn1_named_data **list,
                                        ...
                                        size_t val_len );
# 32 "../../../ThirdParty/mbedTLS/library/pkwrite.c" 2
...
# 33 "../../../ThirdParty/mbedTLS/library/pkwrite.c" 2
...
# 36 "../../../ThirdParty/mbedTLS/library/pkwrite.c" 2
# 47 "../../../ThirdParty/mbedTLS/library/pkwrite.c"
...
# 48 "../../../ThirdParty/mbedTLS/library/pkwrite.c" 2
...
# 56 "../../../ThirdParty/mbedTLS/library/pkwrite.c" 2
# 75 "../../../ThirdParty/mbedTLS/library/pkwrite.c"
                                ...
                                mbedtls_rsa_context *rsa )
{
    ...
    if ( ( ret = mbedtls_rsa_export( rsa, 0, 0, 0, 0, &T ) ) != 0 ||
            ( ret = mbedtls_asn1_write_mpi( p, start, &T ) ) < 0 )
        goto end_of_export;
    len += ret;


    if ( ( ret = mbedtls_rsa_export( rsa, &T, 0, 0, 0, 0 ) ) != 0 ||
            ( ret = mbedtls_asn1_write_mpi( p, start, &T ) ) < 0 )
        goto end_of_export;
    len += ret;
...
# 203 "../../../ThirdParty/mbedTLS/library/pkwrite.c"
                return( -0x3980 );
...
# 279 "../../../ThirdParty/mbedTLS/library/pkwrite.c"
...
int mbedtls_pk_write_key_der( mbedtls_pk_context *key, unsigned char *buf, size_t size )
{
    ...
    if( mbedtls_pk_get_type( key ) == MBEDTLS_PK_RSA )
    {
        ...
        if( ( ret = mbedtls_rsa_export_crt( rsa, 0, 0, &T ) ) != 0 ||
                ( ret = mbedtls_asn1_write_mpi( &c, buf, &T ) ) < 0 )
            goto end_of_export;
        len += ret;


        if( ( ret = mbedtls_rsa_export_crt( rsa, 0, &T, 0 ) ) != 0 ||
                ( ret = mbedtls_asn1_write_mpi( &c, buf, &T ) ) < 0 )
            goto end_of_export;
        len += ret;


        if( ( ret = mbedtls_rsa_export_crt( rsa, &T, 0, 0 ) ) != 0 ||
                ( ret = mbedtls_asn1_write_mpi( &c, buf, &T ) ) < 0 )
            goto end_of_export;
        len += ret;


        if ( ( ret = mbedtls_rsa_export( rsa, 0, 0,
                                         &T, 0, 0 ) ) != 0 ||
                ( ret = mbedtls_asn1_write_mpi( &c, buf, &T ) ) < 0 )
            goto end_of_export;
        len += ret;
        ...
        if ( ( ret = mbedtls_rsa_export( rsa, 0, &T,
                                         0, 0, 0 ) ) != 0 ||
                ( ret = mbedtls_asn1_write_mpi( &c, buf, &T ) ) < 0 )
            goto end_of_export;
        len += ret;
        ...
        if ( ( ret = mbedtls_rsa_export( rsa, &T, 0,
                                         0, 0, 0 ) ) != 0 ||
                ( ret = mbedtls_asn1_write_mpi( &c, buf, &T ) ) < 0 )
            goto end_of_export;
        len += ret;
...
# 405 "../../../ThirdParty/mbedTLS/library/pkwrite.c"
...
# 539 "../../../ThirdParty/mbedTLS/library/pkwrite.c"
